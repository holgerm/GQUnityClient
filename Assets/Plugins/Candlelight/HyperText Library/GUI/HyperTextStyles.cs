...
// 
// This file contains a class for describing styles to be used with a HyperText.
...
{
	/// <summary>
	/// A class for describing different styles for a Candlelight.HyperText component.
	/// </summary>
	public class HyperTextStyles : ScriptableObject
	{
		...
		/// </summary>
		[System.Serializable]
		public struct Link : IPropertyBackingFieldCompatible
		{
			/// <summary>
			/// The color tint mode explanation.
			/// </summary>
			public const string colorTintModeExplanation = "Base color is <color> tag value if enabled, font color " +
				"if not. Each state color is multiplied by the color multiplier. Color tint mode describes how the " +
				"postmultiplied state color should blend with the base color.";
			...
			public static Link DefaultStyle
			{
				get
				{
					...
					return new Link(
						...
						Candlelight.ColorTween.Mode.All,
			...
			[SerializeField, Tooltip(colorTintModeExplanation)]
			...
			/// <summary>
			/// Initializes a new instance of the <see cref="Candlelight.UI.HyperTextStyles+Link"/> struct.
			/// </summary>
			...
			) : this()
			{
				...
				this.m_ColorTintMode = colorTintMode;
				this.m_ColorTweenMode = colorTweenMode;
			...
			/// <summary>
			/// Serves as a hash function for a <see cref="Candlelight.UI.HyperText+KeywordCollectionClass"/> object.
			/// </summary>
			/// <returns>
			...
			public override int GetHashCode()
			{
				return ObjectX.GenerateHashCode(
					this.m_Colors.GetHashCode(),
					this.m_ColorTintMode.GetHashCode(),
					this.m_ColorTweenMode.GetHashCode(),
					this.m_TextStyle.GetHashCode(),
					this.m_VerticalOffset.GetHashCode()
				);
			}
		...
		/// </summary>
		[System.Serializable]
		public struct LinkSubclass : IIdentifiable<string>, IPropertyBackingFieldCompatible
		{
			#region Backing Fields
			...
			public string Identifier { get { return ClassName; } }
			/// <summary>
			/// Gets the style.
			/// </summary>
			...
			/// <summary>
			/// Initializes a new instance of the <see cref="Candlelight.UI.HyperTextStyles+LinkSubclass"/> struct.
			/// </summary>
			...
			{
				return ObjectX.GenerateHashCode(
					string.IsNullOrEmpty(this.m_ClassName) ? typeof(string).GetHashCode() : this.m_ClassName.GetHashCode(),
					this.m_Style.GetHashCode()
				);
			}
		...
		/// </summary>
		[System.Serializable]
		public struct Quad : IIdentifiable<string>, IPropertyBackingFieldCompatible
		{
			#region Backing Fields
			[SerializeField]
			...
			public string LinkClassName { get { return m_LinkClassName ?? string.Empty; } }
			/// <summary>
			/// Gets the link identifier.
			/// </summary>
			/// <value>The link identifier.</value>
			public string LinkId { get { return m_LinkId ?? string.Empty; } }
			/// <summary>
			/// Gets a value indicating whether this <see cref="Candlelight.UI.HyperTextStyles+Quad"/> should
			/// respect colorization.
			/// </summary>
			/// <value><c>true</c> if should respect colorization; otherwise, <c>false</c>.</value>
			...
			/// <summary>
			/// Initializes a new instance of the <see cref="Candlelight.UI.HyperTextStyles+Quad"/> struct.
			/// </summary>
			/// <param name="sprite">Sprite.</param>
			/// <param name="className">Class name.</param>
			/// <param name="sizeScalar">Size scalar.</param>
			/// <param name="verticalOffset">Vertical offset.</param>
			/// <param name="shouldRespectColorization">If set to <c>true</c> should respect colorization.</param>
			...
			/// <see cref="Candlelight.UI.HyperTextStyles+Quad"/>.
			/// </summary>
			/// <param name="obj">
			...
			/// <see cref="Candlelight.UI.HyperTextStyles+Quad"/>; otherwise, <c>false</c>.
			/// </returns>
			public override bool Equals(object obj)
			{
				return obj != null && obj is Quad && obj.GetHashCode() == GetHashCode();
			}
			...
			public override int GetHashCode()
			{
				return ObjectX.GenerateHashCode(
					string.IsNullOrEmpty(this.m_ClassName) ? typeof(string).GetHashCode() : this.m_ClassName.GetHashCode(),
					string.IsNullOrEmpty(this.m_LinkClassName) ? typeof(string).GetHashCode() : this.m_LinkClassName.GetHashCode(),
					string.IsNullOrEmpty(this.m_LinkId) ? typeof(string).GetHashCode() : this.m_LinkId.GetHashCode(),
					this.m_ShouldRespectColorization.GetHashCode(),
					this.m_SizeScalar.GetHashCode(),
					this.m_Sprite == null ? typeof(Sprite).GetHashCode() : this.m_Sprite.GetHashCode(),
					this.m_VerticalOffset.GetHashCode()
				);
			}
		...
		/// </summary>
		[System.Serializable]
		public struct Text : IIdentifiable<string>, IPropertyBackingFieldCompatible
		{
			/// <summary>
			/// An allocation for the validation status message.
			/// </summary>
			private static string validationStatusMessage = null;
			/// <summary>
			/// The valid tag match pattern.
			/// </summary>
			private static readonly string validTagMatchPattern = @"^\w+$";
			/// <summary>
			/// The valid tag regex.
			/// </summary>
			private static readonly System.Text.RegularExpressions.Regex validTagRegex =
				new System.Text.RegularExpressions.Regex(validTagMatchPattern);
			...
			/// <see cref="Candlelight.UI.HyperTextStyles"> on which the tag is defined.
			...
			public static ValidationStatus ValidateTag(string tag, out string statusMessage)
			{
				...
				if (!validTagRegex.IsMatch(tag))
				{
					statusMessage = string.Format(
						"Supplied tag contains invalid characters. Must match pattern: {0}", validTagMatchPattern
					);
					return ValidationStatus.Error;
				}
			...
			#region Backing Fields
			[SerializeField, StatusProperty(typeof(HyperTextStyles.Text), "ValidateTag")]
			...
			/// </summary>
			/// <value>The identifier.</value>
			public string Identifier { get { return Tag; } }
			/// <summary>
			/// Gets the tag used to indicate this style.
			/// </summary>
			/// <value>The tag.</value>
			public string Tag { get { return m_Tag ?? string.Empty; } }
			/// <summary>
			...
			/// <summary>
			/// Initializes a new instance of the <see cref="Candlelight.UI.HyperTextStyles+CustomTextStyle"/> struct.
			/// </summary>
			/// <param name="tag">Tag.</param>
			/// <param name="textStyle">Text style.</param>
			/// <param name="verticalOffset">Vertical offset.</param>
...
#pragma warning disable 219
				ValidationStatus validationStatus = ValidateTag(tag, out validationStatusMessage);
#pragma warning restore 219
				if (tag == null)
				{
					throw new System.ArgumentNullException("tag", validationStatusMessage);
				}
#if !UNITY_EDITOR
				if (validationStatus == ValidationStatus.Error)
				{
					throw new System.ArgumentException(validationStatusMessage, "tag");
				}
#endif
				this.m_Tag = tag;
				this.m_TextStyle = textStyle;
			...
			{
				return ObjectX.GenerateHashCode(
					string.IsNullOrEmpty(this.m_Tag) ? typeof(string).GetHashCode() : this.m_Tag.GetHashCode(),
					this.m_TextStyle.GetHashCode(),
					this.m_VerticalOffset.GetHashCode()
				);
			}
		...
		/// <summary>
		/// Gets the font status.
		/// </summary>
		/// <remarks>
		/// This method only exists for the status tooltip.
		/// </remarks>
		/// <returns>The font status.</returns>
		/// <param name="provider"><see cref="Candlelight.UI.HyperTextStyles"> on which the font is defined.</param>
		/// <param name="font">Font.</param>
		/// <param name="message">Message.</param>
		private static ValidationStatus GetFontStatus(Object provider, object font, out string message)
		{
			HyperTextStyles styles = provider as HyperTextStyles;
			if (font == null || (Object)font == null) // NOTE: unassigned Unity Objects may be in a container
			{
				if (styles.CascadedFont == null)
				{
					message = "Font cannot be null.";
					return ValidationStatus.Error;
				}
				else
				{
					message = string.Format(
						"Inheriting font {0} from {1}.",
						styles.CascadedFont.name,
						styles.m_InheritedStyles.Where(s => s != null && s.CascadedFont != null).Reverse().First().name
					);
					return ValidationStatus.Info;
				}
			}
			else if (!(font as Font).dynamic)
			{
				message = "Font size and style overrides are only supported for dynamic fonts. " +
					"Only colors and offsets will be applied.";
				return ValidationStatus.Warning;
			}
			else if (styles.m_InheritedStyles.Where(s => s != null && s.CascadedFont != null).Count() > 0)
			{
				message = "Overriding inherited font.";
				return ValidationStatus.Warning;
			}
		...
		#region Backing Fields
		private List<LinkSubclass> m_CascadedLinkStyles = new List<LinkSubclass>(64);
		private List<Quad> m_CascadedQuadStyles = new List<Quad>(64);
		private List<Text> m_CascadedTextStyles = new List<Text>(64);
		private Dictionary<LinkSubclass, HyperTextStyles> m_InheritedLinkStyles =
			new Dictionary<LinkSubclass, HyperTextStyles>();
		private Dictionary<Quad, HyperTextStyles> m_InheritedQuadStyles =
			new Dictionary<Quad, HyperTextStyles>();
		private Dictionary<Text, HyperTextStyles> m_InheritedTextStyles =
			new Dictionary<Text, HyperTextStyles>();
		...
		[SerializeField, PropertyBackingField(
			typeof(StatusPropertyAttribute), typeof(HyperTextStyles), "GetFontStatus"
		)]
		...
		/// <summary>
		/// Gets the color of the cascaded default text.
		/// </summary>
		/// <value>The color of the cascaded default text.</value>
		...
		/// <summary>
		/// Gets the size of the cascaded font.
		/// </summary>
		/// <value>The size of the cascaded font.</value>
		...
		/// <summary>
		/// Gets or sets a value indicating whether this <see cref="Candlelight.UI.HyperTextStyles"/> should override
		/// inherited default font style.
		/// </summary>
		/// <value><c>true</c> if should override inherited default font style; otherwise, <c>false</c>.</value>
		...
		/// </summary>
		/// <value><c>true</c> if should override inherited default text color; otherwise, <c>false</c>.</value>
		...
		/// <summary>
		/// Gets or sets a value indicating whether this <see cref="Candlelight.UI.HyperTextStyles"/> should override
		/// inherited default link style.
		/// </summary>
		/// <value><c>true</c> if should override inherited default link style; otherwise, <c>false</c>.</value>
		...
		/// inherited font size.
		/// </summary>
		/// <value><c>true</c> if should override inherited font size; otherwise, <c>false</c>.</value>
		...
		/// </summary>
		/// <value><c>true</c> if should override inherited line spacing; otherwise, <c>false</c>.</value>
		...
		/// <typeparam name="T">A <see cref="Candlelight.IIdentifiable"/> style type.</typeparam>
		...
		) where T: IIdentifiable<string>, new()
		{
			...
			foreach (KeyValuePair<T, HyperTextStyles> kv in styles)
			{
				...
				{
					if (cascadeKeys[i].Identifier == kv.Key.Identifier)
					{
						existingKey = cascadeKeys[i];
						break;
					}
				}
				if (existingKey.Identifier == kv.Key.Identifier)
				{
					if (
		...
		[System.Obsolete("Use void HyperTextStyles.GetCustomTextStyles(ref List<Text> text)")]
		public Text[] GetCustomTextStyles() // TODO: make private
		{
		...
		[System.Obsolete("Use void HyperTextStyles.GetInheritedStyles(ref List<HyperTextStyles> styles)")]
		public HyperTextStyles[] GetInheritedStyles() // TODO: make private
		{
		...
		[System.Obsolete("Use void HyperTextStyles.GetLinkStyles(ref List<LinkSubclass> links)")]
		public LinkSubclass[] GetLinkStyles() // TODO: make private
		{
		...
		[System.Obsolete("Use void HyperTextStyles.GetQuadStyles(ref List<Quad> quads)")]
		public Quad[] GetQuadStyles() // TODO: make private
		{
		...
		private void RebuildCascadingAndInheritedStyles()
		{
			...
			foreach (HyperTextStyles styles in m_InheritedStyles)
			{
				...
				AddToCascade<LinkSubclass>(styles.m_InheritedLinkStyles, m_InheritedLinkStyles);
				AddToCascade<LinkSubclass>(styles.m_LinkStyles.ToDictionary(k => k, v => styles), m_InheritedLinkStyles);
				AddToCascade<Quad>(styles.m_InheritedQuadStyles, m_InheritedQuadStyles);
				AddToCascade<Quad>(styles.m_QuadStyles.ToDictionary(k => k, v => styles), m_InheritedQuadStyles);
				AddToCascade<Text>(styles.m_InheritedTextStyles, m_InheritedTextStyles);
				AddToCascade<Text>(styles.m_CustomTextStyles.ToDictionary(k => k, v => styles), m_InheritedTextStyles);
			}
			// rebuild cascades
			s_CascadedLinkStyles.Clear();
			s_CascadedQuadStyles.Clear();
			s_CascadedTextStyles.Clear();
			AddToCascade<LinkSubclass>(m_InheritedLinkStyles, s_CascadedLinkStyles);
			AddToCascade<Quad>(m_InheritedQuadStyles, s_CascadedQuadStyles);
			AddToCascade<Text>(m_InheritedTextStyles, s_CascadedTextStyles);
			...
			AddToCascade<LinkSubclass>(s_SelfLinkStyles, s_CascadedLinkStyles);
			AddToCascade<Quad>(s_SelfQuadStyles, s_CascadedQuadStyles);
			AddToCascade<Text>(s_SelfTextStyles, s_CascadedTextStyles);
		...
		{
			SetCustomTextStyles(styles, Application.isPlaying);
		}
		...
		/// </summary>
		/// <param name="styles">Custom text styles.</param>
		/// <param name="validate">If set to <c>true</c> then throw an exception if incoming data are invalid.
		/// <exception cref="System.ArgumentException">
		/// Thrown if the supplied array has at least one tag occurring multiple times.
		/// </exception>
		public void SetCustomTextStyles(IEnumerable<Text> styles, bool validate = true)
		{
			styles = styles ?? new Text[0];
			if (validate)
			{
				string[] ids = (from style in styles select style.Identifier).ToArray();
				HashSet<string> uniqueIds = new HashSet<string>(ids);
				if (ids.Length != uniqueIds.Count)
				{
					throw new System.ArgumentException(
						"One or more tags in the supplied styles are not unique.", "customTextStyles"
					);
				}
			}
			m_CustomTextStyles.Clear();
			m_CustomTextStyles.AddRange(styles);
			RebuildCascadingAndInheritedStyles();
			m_OnStylesChanged.Invoke();
		}
...
#pragma warning restore 109
		...
		{
			if (m_InheritedStyles.SequenceEqual(styles))
			{
				return;
			}
			foreach (HyperTextStyles style in m_InheritedStyles)
			...
			foreach (HyperTextStyles style in styles)
			{
				if (style == this)
				{
					continue;
		...
		/// </summary>
		/// <param name="linkStyles">Link styles.</param>
		private void SetLinkStyles(LinkSubclass[] styles)
		{
			SetLinkStyles(styles, Application.isPlaying);
		}
		...
		/// <param name="validate">If set to <c>true</c> then throw an exception if incoming data are invalid.
		/// <exception cref="System.ArgumentException">
		/// Thrown if the supplied array has at least one class name occurring multiple times.
		/// </exception>
		public void SetLinkStyles(IEnumerable<LinkSubclass> styles, bool validate = true)
		{
			styles = styles ?? new LinkSubclass[0];
			if (validate)
			{
				string[] ids = (from style in styles select style.Identifier).ToArray();
				HashSet<string> uniqueIds = new HashSet<string>(ids);
				...
				{
					throw new System.ArgumentException(
						"One or more class names in the supplied styles are not unique.", "styles"
					);
				}
			}
			m_LinkStyles.Clear();
			m_LinkStyles.AddRange(styles);
			RebuildCascadingAndInheritedStyles();
			m_OnStylesChanged.Invoke();
		}
		...
		{
			SetQuadStyles(styles, Application.isPlaying);
		}
		...
		/// Thrown if the supplied array has at least one class name occurring multiple times.
		/// </exception>
		public void SetQuadStyles(IEnumerable<Quad> styles, bool validate = true)
		{
			styles = styles ?? new Quad[0];
			if (validate)
			{
				string[] ids = (from style in styles select style.Identifier).ToArray();
				HashSet<string> uniqueIds = new HashSet<string>(ids);
			...
			m_QuadStyles.Clear();
			m_QuadStyles.AddRange(styles);
			RebuildCascadingAndInheritedStyles();
			m_OnStylesChanged.Invoke();
		}

		#region Obsolete
		[System.Obsolete("Use void HyperTextStyles.GetCascadedCustomTextStyles(ref List<Text> text)")]
		public Text[] GetCascadedCustomTextStyles()
		{
			if (!m_AreCascadesInitialized)
			{
				RebuildCascadingAndInheritedStyles();
			}
			return m_CascadedTextStyles.ToArray();
		}
		[System.Obsolete("Use void HyperTextStyles.GetCascadedLinkStyles(ref List<LinkSubclass> links)")]
		public LinkSubclass[] GetCascadedLinkStyles()
		{
			if (!m_AreCascadesInitialized)
			{
				RebuildCascadingAndInheritedStyles();
			}
			return m_CascadedLinkStyles.ToArray();
		}
		[System.Obsolete("Use void HyperTextStyles.GetCascadedQuadStyles(ref List<Quad> quads)")]
		public Quad[] GetCascadedQuadStyles()
		{
			if (!m_AreCascadesInitialized)
			{
				RebuildCascadingAndInheritedStyles();
			}
			return m_CascadedQuadStyles.ToArray();
		}
		#endregion
	}
}