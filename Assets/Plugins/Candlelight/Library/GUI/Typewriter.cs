...
#pragma warning restore 414
		...
		[Header("Events")]
		[SerializeField, UnityEngine.Serialization.FormerlySerializedAs("m_OnTypeCharacter")]
		private TypewriterCharacterEvent m_TypedCharacter = new TypewriterCharacterEvent();
		[SerializeField, UnityEngine.Serialization.FormerlySerializedAs("m_OnFinish")]
		private TypewriterEvent m_Finished = new TypewriterEvent();
		#endregion
		...
		public TypewriterEvent Finished { get { return m_Finished; } }
		/// <summary>
		...
		public TypewriterCharacterEvent TypedCharacter { get { return m_TypedCharacter; } }
		#endregion
		...
		protected virtual void Update()
		{
			...
			bool didCursorChange = !string.IsNullOrEmpty(m_Cursor) && m_CursorBlinkTimer > m_CursorBlink;
		...
		private void UpdateOutputText(bool didTypeCharacter)
		{
			...
			{
				m_TypedCharacter.Invoke(this, text[m_CurrentIndex]);
			}
			else
			{
		...
		#region Obsolete
		[System.Obsolete("Use Candlelight.UI.TypeWriter.Finished")]
		public TypewriterEvent OnFinished { get { return this.Finished; } }
		[System.Obsolete("Use Candlelight.UI.TypeWriter.TypedCharacter")]
		public TypewriterCharacterEvent OnTypedCharacter { get { return this.TypedCharacter; } }
		#endregion
	}
}