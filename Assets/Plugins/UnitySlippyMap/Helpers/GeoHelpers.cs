    ...
    public class GeoHelpers
    {
        ...
        */
		...
		public static double[] RaycastHitToWGS84(Map map, RaycastHit r)
		{
			...
			Debug.Log ("raycasthit:" + UnityEngine.EventSystems.EventSystem.current.IsPointerOverGameObject ());
			...
			if (UnityEngine.EventSystems.EventSystem.current.IsPointerOverGameObject ()) {
				...
				return new double[]{0d,0d};
								...
								double[] RaycastHitToEPSG900913 = new double[] {
										(map.CenterEPSG900913 [0]) + (r.point.x / map.ScaleMultiplier) ,
										(map.CenterEPSG900913 [1]) + (r.point.z / map.ScaleMultiplier)
								};
