...
namespace GQ.Client.Model
{
	...
	public class PageNavigation : Page {
		...
		protected override void ReadAttributes (XmlReader reader)
		{
			...
			mapOption = GQML.GetRequiredBoolAttribute (GQML.PAGE_NAVIGATION_OPTION_MAP, reader);

			listOption = false; // GQML.GetRequiredBoolAttribute (GQML.PAGE_NAVIGATION_OPTION_LIST, reader);

			qrOption = GQML.GetRequiredBoolAttribute (GQML.PAGE_NAVIGATION_OPTION_QR, reader);
			...
			nfcOption = GQML.GetRequiredBoolAttribute (GQML.PAGE_NAVIGATION_OPTION_NFC, reader);
			...
			numberOption = GQML.GetRequiredBoolAttribute (GQML.PAGE_NAVIGATION_OPTION_NUMBER, reader);
			...
			iBeaconOption = GQML.GetRequiredBoolAttribute (GQML.PAGE_NAVIGATION_OPTION_IBEACON, reader);
