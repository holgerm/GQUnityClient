...
public class createquestbuttons : MonoBehaviour
{
	...
	void Start ()
	{
		...
		if (!Application.isWebPlayer) {
			...
			if ((questdb.allquests.Count < 1 && filteredOfflineList.Count < 1) || ConfigurationManager.Current.showCloudQuestsImmediately) {
//				LoadQuestsFromServer();
	...
	bool showHiddenQuests = false;

	public void setShowHiddenQuests (bool showHidden)
	{
...
//		show &= (!showRegionalQuestsOnly || currentRegions.ContainQuest(q)); TODO
	...
	public void  DisplayList ()
	{
		...
		foreach (Quest q in filteredOfflineList) {
			if (showHiddenQuests || !q.IsHidden)
				showoffline.Add (q);
		}
