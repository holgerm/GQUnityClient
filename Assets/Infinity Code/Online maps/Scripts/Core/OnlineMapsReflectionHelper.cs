...
public static class OnlineMapsReflectionHelper
{
    ...
    public static string GetEnumDescription(Enum value)
    {
        ...
        OnlineMapsDescriptionAttribute[] attributes = (OnlineMapsDescriptionAttribute[])fi.GetCustomAttributes(typeof(OnlineMapsOpenRouteService.DescriptionAttribute), false);
