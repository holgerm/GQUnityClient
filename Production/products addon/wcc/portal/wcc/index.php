...
$url = $_GET['content'];
	...
	<script>
	  	  ...
	  	  window.location.replace("http://qeevee.org:9091/281/login");
...
<base href="http://quest-mill.com/portals/wcc/index.php" />
</head>
...
%general.authpage.background:=!!"https://quest-mill.com/portals/wcc/banner.jpg"!!;;
%general.authpage.logo:=!!"https://quest-mill.com/portals/wcc/logo.png"!!;;
