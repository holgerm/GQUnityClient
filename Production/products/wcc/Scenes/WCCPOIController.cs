...
namespace GQ.Client.UI
{
    ...
    public class WCCPOIController : PageController
    {
        ...
        public override bool ShowsTopMargin
        {
            get
            {
                ...
                {
                    return string.IsNullOrEmpty(myPage.ImageUrl);
                }
            }
        }
        ...
        void AddCurrentText()
        {
            ...
            string currentText = myPage.Text.Decode4TMP();
