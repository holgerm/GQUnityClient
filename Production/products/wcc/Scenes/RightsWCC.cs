...
namespace GQ.Client.Model
{
    ...
    public class RightsWCC : MonoBehaviour
    {
        public WCCPOIController pageCtrl;
        ...
        void Start()
        {
            ...
            string copyright = pageCtrl.myPage.ImageRights;
            ...
            {
                if (copyright.StartsWith("©", System.StringComparison.Ordinal))
                {
